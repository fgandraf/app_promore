...
public class LotTests
{
    ...
    public void Create_Lot_ReturnsTrue()
    {
        ...
        var result = new Promore.Core.Contexts.LotContext.UseCases.Create.Hander(_lotRepository, _userRepository, _regionRepository, _clientRepository).Handle(model).Result;
