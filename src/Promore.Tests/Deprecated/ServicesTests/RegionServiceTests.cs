...
//         var result = new RegionService(_regionRepository, _userRepository).CreateAsync(model).Result;
...
//         var result = new RegionService(_regionRepository, _userRepository).DeleteAsync(ExistentRegiontId).Result;
...
//         
//         var result = new RegionService(_regionRepository, _userRepository).GetAllAsync(new GetAllRegionsRequest()).Result.Value;
//         
...
//     {
//         var result = new RegionService(_regionRepository, _userRepository).GetByIdAsync(ExistentRegiontId).Result.Value;
//         
...
//         
//         var result = new RegionService(_regionRepository, _userRepository).UpdateAsync(model).Result;
