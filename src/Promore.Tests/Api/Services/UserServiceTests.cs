...
//         var result = new UserService(_userRepository,_regionRepository,_roleRepository).CreateAsync(model).Result;
...
//         
//         var result = new UserService(_userRepository,_regionRepository,_roleRepository).RemoveLotFromUserAsync(new RemoveLotFromUserRequest{Id = ExistentUserId, LotId = ExistentLotId}).Result;
//         
...
//         
//         var result = new UserService(_userRepository,_regionRepository,_roleRepository).GetAllAsync(new GetAllUsersRequest()).Result.Value;
//         
...
//     {
//         var result = new UserService(_userRepository,_regionRepository,_roleRepository).GetByEmailAsync(ExistentEmail).Result.Value;
//         
...
//     {
//         var result = new UserService(_userRepository,_regionRepository,_roleRepository).GetByIdAsync(ExistentUserId).Result.Value;
//         
//         Assert.IsNotNull(result);
//     }
//
...
//         
//         var result = new UserService(_userRepository,_regionRepository,_roleRepository).GetUserByLoginAsync(model).Result.Value;
//         
//         Assert.IsNotNull(result);
//     }
//     
...
//         
//         var result = new UserService(_userRepository,_regionRepository,_roleRepository).UpdateInfoAsync(model).Result;
...
//         
//         var result = new UserService(_userRepository,_regionRepository,_roleRepository).UpdateSettingsAsync(model).Result;
