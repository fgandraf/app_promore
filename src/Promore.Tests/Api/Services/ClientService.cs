...
public class ClientService
{
    ...
    public void Create_Client_ReturnsTrue()
    {
        ...
        //var result = new Create(_clientRepository,_lotRepository).Handle(model).Result;
        var result = new Promore.Api.Services.ClientService(_clientRepository, _lotRepository).CreateAsync(model).Result;
    ...
    public void Delete_Client_ReturnsTrue()
    {
        ...
        var result = new Promore.Api.Services.ClientService(_clientRepository, _lotRepository).DeleteAsync(ExistentClientId).Result;
    ...
    public void GetAll_Clients_SameCountThanMock()
    {
        ...
        var result = new Promore.Api.Services.ClientService(_clientRepository, _lotRepository).GetAllAsync().Result.Value;
    ...
    public void GetAll_ClientsByLotId_SameCountThanMock()
    {
        ...
        var result = new Promore.Api.Services.ClientService(_clientRepository, _lotRepository).GetAllByLotIdAsync(existentLotId).Result.Value;
    ...
    {
        var result = new Promore.Api.Services.ClientService(_clientRepository, _lotRepository).GetByIdAsync(ExistentClientId).Result.Value;
    ...
    public void Update_Client_ReturnsTrue()
    {
        ...
        var result = new Promore.Api.Services.ClientService(_clientRepository, _lotRepository).UpdateAsync(model).Result;
    ...
    private static CreateClientRequest BuildCreateClientRequest(string notExistentCpf, string existentLotId)
    {
